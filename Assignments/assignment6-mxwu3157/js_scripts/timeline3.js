...
d3.json('./data/fall19.json').then(data => {
    ...
    d3.select('#title3').text(`${data.name} : ${semesterDays} days, ${data.instructional_days} instructional days, ${classesDays} classes days`);
