...
d3.json('./data/fall20.json').then(data => {
    ...
    d3.select('#title4').text(`${data.name} : ${semesterDays} days, ${data.instructional_days} instructional days, ${classesDays} classes days`);
