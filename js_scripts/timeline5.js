...
d3.json('./data/fall21.json').then(data => {
    ...
    d3.select('#title5').text(`${data.name} : ${semesterDays} days, ${data.instructional_days} instructional days, ${classesDays} classes days`);
