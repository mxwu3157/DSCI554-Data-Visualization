...
Histograms are realized using `geom_histogram`. Frequency polygons are realized using `geom_freqpoly`.
...
**What happens if `month` is not a factor with ordered levels:** <!-- you answer here -->
